...
class DetailsGrid(DefaultModel):
    registered_in_sppi: bool


class Details(DetailsGrid):
    ...
    mailing_addresses: Optional[List[MailingAddress]] = Field


class DetailsFactory(factory.Factory):
    class Meta:
        model = Details

    registered_in_sppi: bool = factory.Faker('boolean')
